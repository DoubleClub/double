...
import "./interfaces/double/ITokenLocker.sol";
...
contract FeeDistributor is Initializable, OwnableUpgradeable {
        ...
        returns (bool)
    {
        if (_amount > 0) {
            ...
            uint256 received = IERC20Upgradeable(_token).balanceOf(address(this));
            IERC20Upgradeable(_token).safeTransferFrom(msg.sender, address(this), _amount);
            received = IERC20Upgradeable(_token).balanceOf(address(this)) - received;
